window.TopicGrid = function TopicGrid({ topics, currentLanguage, onSelectTopic, basePath }) {
    ...
    const getImageUrl = (topicId) => {
        const imageUrl = `${basePath}/images/topics/${topicId}.jpg`;
        console.log('Attempting to load image for topic:', topicId, 'URL:', imageUrl);
        return imageUrl;
    };

    // Log the topics we're working with
                ...
                React.createElement(React.Fragment, null,
                    React.createElement("div", {
                        ...
                        React.createElement("img", {
                            ...
                            onError: (e) => {
                                console.log('Image load failed for topic:', id);
